    ...
    ready: function(modal, trigger) {
      $.ajax({
        ...
        success: function(data) {
          loadStats(data)
          var data_to_show = jQuery(data);
          //var data_to_show2 = JSON.parse(data);
          // alert(data_to_show)
          //alert(JSON.stringify(data);
          alert(JSON.stringify(data_to_show));
          alert(JSON.stringify(data));
          //alert(data_to_show2)
        }, error: function(data){
          var bad_data = jQuery(data);
          //loadStats(data)
          //alert("Oops. This model is not so smart yet. Upload an 'easier' image!")
          //error: function(error)
          alert("Oops. This model is not so smart yet. Upload an 'easier' image! Btw: it returned:" + bad_data)
        }
      }).always(function() {
        modal.modal('close');
      });
